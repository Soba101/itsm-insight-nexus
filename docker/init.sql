-- ITSM Insight Nexus Database Initialization
-- This script combines all migrations for Docker container setup
...
-- Grant permissions (Docker doesn't have Supabase RLS, so we keep it simple)
